...
barra.innerHTML = ` 
<div 
class="fixed z-0 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
  ...
  <a data-tooltip-target="tooltip-home" href="index.html" class="inline-flex flex-col items-center justify-center px-5 rounded-l-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
      ...
      <div class="flex items-center justify-center">
          <a data-tooltip-target="tooltip-new" href="locations.html" class="inline-flex items-center justify-center w-10 h-10 font-medium bg-blue-600 rounded-full hover:bg-blue-800 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
